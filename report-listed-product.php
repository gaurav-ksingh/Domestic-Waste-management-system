...
<!DOCTYPE html>
<head>
<title>Domestic waste Management system|| Listed Product Reports  </title>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            B/w Dates Listed Products Report Date Selection
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <form class="cmxform form-horizontal " method="post" name="bwdatesreportds" action="bwdates-product-report-details.php">
