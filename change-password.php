...
$query=mysqli_query($con,"select ID from tblemployee where ID='$eid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblemployee set Password='$newpassword' where ID='$uid'");
...
<!DOCTYPE html>
<head>
<title>Electronic Waste System || Change Password  </title>
