...
<!DOCTYPE html>
<head>
<title>Domestic waste Management system|| Report of Registered Employees  </title>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            B/w Dates Report of Employees Date Selection
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <form class="cmxform form-horizontal " method="post" name="bwdatesreportds" action="bwdates-employee-report-details.php">
