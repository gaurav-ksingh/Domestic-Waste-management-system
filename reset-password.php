...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tblemployee set Password='$password'  where  Email='$email' && ContactNumber='$contactno' ");
   if($query)
   {
...
<div class="w3layouts-main">
	<h2 style="color:#fff">Employee | Recover Password</h2>
