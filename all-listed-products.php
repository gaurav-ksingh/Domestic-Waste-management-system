...
<!DOCTYPE html>
<head>
<title>Domestic waste Management system || All Listed Product</title>
...
$ret=mysqli_query($con,"select tblproduct.ID as pid,tblproduct.Status,tblproduct.ProductId,tblproduct.ContactPerson,tblproduct.CPMobNumber,tblproduct.CreationDate,tblproduct.ProductName,tblcategory.ID,tblcategory.CategoryName,tbluser.FullName,tbluser.MobileNumber from  tblproduct join tbluser on tblproduct.UserID=tbluser.ID join tblcategory on tblproduct.CategoryID=tblcategory.ID");
$cnt=1;
