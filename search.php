...
<!DOCTYPE html>
<head>
<title>Domestic Waste Management System||Search Listed Product Details </title>
<!-- bootstrap-css -->
 ...
 <div class="panel panel-default">
    ...
    <div>
       <form class="cmxform form-horizontal" method="post" action="" name="search">
                                    ...
                                    <div class="form-group ">
                                        <label for="username" class="control-label col-lg-6">Search by Request Number / Use Name / User Mobile No:</label>
                                        <div class="col-lg-6">
...
<div class="panel-heading">
      ...
      <table class="table table-bordered">
       ...
       <thead>
         ...
         <?php
        $eid= $_SESSION['empid'];
$ret=mysqli_query($con,"select tblproduct.ID as pid,tblproduct.ProductId,tblproduct.Status,tblproduct.ContactPerson,tblproduct.CPMobNumber,tblproduct.CreationDate,tblproduct.ProductName,tblcategory.ID,tblcategory.CategoryName,tbluser.FullName,tbluser.MobileNumber from  tblproduct join tbluser on tblproduct.UserID=tbluser.ID join tblcategory on tblproduct.CategoryID=tblcategory.ID where tblproduct.AssignTo='$eid' and (tblproduct.ProductId like '%$sdata%' || tbluser.FullName  like '%$sdata%' || tbluser.MobileNumber like '%$sdata%') ");
$cnt=1;
