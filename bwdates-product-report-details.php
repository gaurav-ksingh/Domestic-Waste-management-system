...
<!DOCTYPE html>
<head>
<title>Domestic waste Management system|| B/w Dates Report Details</title>
...
<div class="panel-heading">
            B/w Dates Report of Listed Products  From <?php echo $fdate;?> To <?php echo $tdate;?></div>
...
?>
        ...
        <?php
$ret=mysqli_query($con,"select tblproduct.ID as pid,tblproduct.ProductId,tblproduct.Status,tblproduct.ContactPerson,tblproduct.CPMobNumber,tblproduct.CreationDate,tblproduct.ProductName,tblcategory.ID,tblcategory.CategoryName,tbluser.FullName,tbluser.MobileNumber from  tblproduct join tbluser on tblproduct.UserID=tbluser.ID join tblcategory on tblproduct.CategoryID=tblcategory.ID where date(tblproduct.CreationDate) between '$fdate' and '$tdate'");
$cnt=1;
...
<?php } ?>
                  ...
                  <td><a href="product-details.php?pid=<?php echo $row['pid'];?>&&productid=<?php echo $row['ProductId'];?>" class="btn btn-primary" target="_blank">View</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
} } else {?>
